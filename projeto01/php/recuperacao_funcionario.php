...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_check_email = "SELECT * FROM funcionario WHERE Email='$email'";
    ...
    if ($result_check_email->num_rows > 0) {
        ...
        $sql_update_token = "UPDATE funcionario SET SenhaToken='$token' WHERE Email='$email'";
        ...
        // Buscar nome e sexo do funcionário
        ...
        $mensagem = '
            ...
            <body>
                <div class="x">
                    ...
                    <p class="message">Após receber o código, visite o seguinte link para redefinir sua senha: <a href="http://localhost/novoprojeto/php/senha.php">Redefinir Senha</a></p>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    header("Location: ../php/codigo_funcionario.php");
