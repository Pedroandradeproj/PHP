...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "SELECT * FROM Funcionario WHERE (registro = '$usuario' or CPF = '$usuario') AND Senha = '$senha'";
...
<div id="login">
        ...
        <form class="card" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <div class="card-footer">
                ...
                <div class="grid">
                    <a href="../php/cadastro_funcionario.php" class="cadastre_link">Cadastre-se!</a>
                    <a href="../php/recuperacao_funcionario.php" class="esqueceusenha">Esqueceu a Senha</a>
                </div>
            </div>
